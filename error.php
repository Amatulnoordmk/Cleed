...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-8 mt-5">
			<img src="images/logged-out.png" style="max-width: 100%" width="800px">
		</div>
		<div class="col-sm-4 align-self-center mt-2 text-sm-left">
			<h1>Oops!</h1>
			<h3>You haven't log-in yet</h3>
			<h5>Try log-in with your account or<br>sign-up to become part of our family :)</h5>
